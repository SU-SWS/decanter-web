...
<div className="flex flex-col 2xl:flex-row-reverse">
  <div className="2xl:sticky 2xl:top-0 2xl:pl-26 2xl:shrink-0 rs-mb-5 2xl:mb-0">
    <SectionNav>
      <SectionNavItem href="#decanter-6" label="Where can I find Decanter 6 documentation" />
...
<div className="grow">
<Section heading="Where can I find Decanter 6 documentation" id="decanter-6">
Decanter 6 documentation can be found [on the decanter 6 website](https://decanter6.stanford.edu/).
</Section>
...
CSS Trick's Greg Sullivan has a great article about the ins and outs of adding a Tailwind CSS design system to a WordPress theme. [Read it here](https://css-tricks.com/adding-a-tailwind-css-design-system-to-a-wordpress-theme/).
</Section>
