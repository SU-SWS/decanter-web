...
<p class="su-intro-text">This project conforms to level <a href="https://www.w3.org/WAI/GL/WCAG20/"> AA WCAG 2.0</a> standards as required by the university's accessibility policy. For more information on the policy please visit <a href= "https://ucomm.stanford.edu/policies/accessibility-policy.html"> University Communications accessibility policy</a> and the <a href="https://soap.stanford.edu"> Stanford Online Accessibility Program</a>.</p>
