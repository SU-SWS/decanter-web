...
export const parentItem = 'su-w-full su-text-left su-text-21 su-group su-no-underline hocus:su-underline su-border-l-5 su-py-16 su-block su-pl-26 su-pr-48 su-transition-all su-duration-300 su-font-semibold su-text-white hocus:su-text-white su-border-transparent hocus:su-border-white hocus:su-underline';
