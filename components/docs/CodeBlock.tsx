...
const syntaxKind = (token: string, source: string, end: number): SyntaxKind => {
...
const CodePanel = ({ code, language }: Pick<CodeTab, 'code' | 'language'>) => {
  return (
...
export const CodeBlock = ({ className = '', code, language = 'text', label }: CodeBlockProps) => {
  return (
...
export const TabbedCodeBlock = ({ className = '', tabs }: { className?: string; tabs: CodeTab[] }) => {
  return (
