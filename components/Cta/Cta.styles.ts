...
export const ctaVariants = {
  primary: 'no-underline leading-display bg-digital-red hocus-visible:bg-black focus-visible:bg-bg-black active:bg-bg-black text-white hocus:text-white hocus:border-lagunita-light shadow hocus:shadow-md hocus:decoration-1 focus:outline-none disabled:border-black-20 disabled:bg-black-20 disabled:text-black',
  secondary: 'no-underline leading-display bg-white hocus:bg-white text-lagunita hocus:text-lagunita-dark border hocus:border rounded border-lagunita-light hocus:border-lagunita-light active:border-lagunita-light shadow hocus-visible:shadow-md focus:ring-2 active:ring-2 focus:ring-lagunita-light active:ring-lagunita-light hocus:decoration-1 focus:outline-none disabled:border-black-30 disabled:bg-black-20 disabled:text-black-80',
  chip: 'rounded-full shadow hocus-visible:shadow-md focus:shadow active:shadow no-underline underline-offset-2 leading-display bg-white hocus:bg-lagunita-20 text-lagunita hocus:text-lagunita-dark border-2 border-lagunita-40 focus:ring-2 active:ring-2 focus:ring-lagunita-40 active:ring-lagunita-40 focus:outline-none hocus:decoration-lagunita hocus:decoration-1',
