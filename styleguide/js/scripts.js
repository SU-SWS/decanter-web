...
/***/
  (function (module, __webpack_exports__, __webpack_require__) {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/main-nav/globals.js
    // ---------------------------------------------------------------------------
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/utilities/keyboard.js
    // ---------------------------------------------------------------------------
    ...
    const isEsc = theKey => (theKey === 'Escape' || theKey === 'Esc' ||
      theKey === 27);
    const isSpace = theKey => (theKey === ' ' || theKey === 'Spacebar' ||
      theKey === 32);
    const isEnter = theKey => (theKey === 'Enter' || theKey === 13);
    const isLeftArrow = theKey => (theKey === 'ArrowLeft' || theKey ===
      'Left' || theKey === 37);
    const isRightArrow = theKey => (theKey === 'ArrowRight' || theKey ===
      'Right' || theKey === 39);
    const isUpArrow = theKey => (theKey === 'ArrowUp' || theKey === 'Up' ||
      theKey === 38);
    const isDownArrow = theKey => (theKey === 'ArrowDown' || theKey ===
      'Down' || theKey === 40);
    /**
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/utilities/events.js
    /**
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/main-nav/NavItem.js
    /**
    ...
    class NavItem_NavItem {
       ...
       */
      isLastItem() {
        return this.nav.items.indexOf(this) === (this.nav.items.length -
          1);
      }
      /**
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/main-nav/Nav.js
    /**
    ...
    class Nav_Nav {
      ...
      constructor(elem) {
        ...
        // .querySelector()
        if (elem instanceof NavItem_NavItem) {
          elem = elem.item;
        }
        ...
        items.forEach(
          item => {
            this.items.push(new NavItem_NavItem(item, this));
          }
        );
      ...
      getTopNav() {
        let nav = this;
        while (nav.elem instanceof NavItem_NavItem) {
       ...
       */
      isExpanded() {
        if (this.elem instanceof NavItem_NavItem) {
      ...
      focusOn(link, currentItem = null) {
        ...
        case 'prev':
          ...
          break;
        default:
          if (Number.isInteger(link) && link >= 0 && link < this.items
            .length) {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/main-nav/main-nav.js
    document.addEventListener('DOMContentLoaded', event => {
      ...
      document.addEventListener('click', event => {
        ...
        if (!target.matches('.' + navClass + ' ' + target
          .tagName)) {
          closeAllSubNavs();
          closeAllMobileNavs();
        }
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/globals.js
    // The css class that this following behaviour is applied to.
    const secondaryNavClass = 'su-secondary-nav';
    // All Secondary navs.
    var secondaryNavs = document.querySelectorAll('.' + secondaryNavClass);
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/nav/ActivePath.js
    /**
     * ActivePath
     *
    ...
    class ActivePath {
      ...
      constructor(element, item, options = {}) {
        ...
        this.itemActiveTrailClass = options.itemActiveTrailClass ||
          'active-trail';
       ...
       */
      expandActivePath() {
        let actives = this.elem.querySelectorAll('.' + this
          .itemActiveClass);
        if (actives.length) {
          actives.forEach(
            element => {
              ...
              while (element) {
                ...
                if (element.tagName === 'LI') {
                  ...
                  // "Hook" of sorts.
                  if (typeof this.item.expandActivePathItem ==
                    'function') {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/nav/EventHandlerDispatch.js
    /**
     ...
     */
    class EventHandlerDispatch_EventHandlerDispatch {
      /**
       * Initialize.
       *
      ...
      callEvent(eventMethod, event, target) {
        if (typeof this.handler.eventRegistry[eventMethod] ===
          'function') {
          var eventObj = new this.handler.eventRegistry[eventMethod](this
            .handler, event, target);
          eventObj.init();
        }
      }
    }
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/nav/ElementFetcher.js
    /**
    ...
    class ElementFetcher {
      ...
      fetch() {
        try {
          ...
          case 'parentButton':
            return this.item.parentNode.parentNode.querySelector(
            'button');
          case 'parentNav':
            return this.item.parentNode.parentNode;
          case 'parentNavLast':
            return this.item.parentNode.parentNode.parentNode
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/EventAbstract.js
    /**
     * EventAbstract
     *
     ...
     */
    class EventAbstract_EventAbstract {
      /**
       * Initialize.
       *
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnEsc.js
    /**
     * OnEsc
     *
     * Event action handler class.
     */
    class OnEsc_OnEsc extends EventAbstract_EventAbstract {
      /**
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnSpace.js
    /**
     * OnSpace
     *
     * Event action handler class.
     */
    class OnSpace_OnSpace extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/SecondaryNavAbstract.js
    /**
     * SecondaryNav Class
     *
     ...
     */
    class SecondaryNavAbstract_SecondaryNavAbstract {
      /**
      ...
      constructor(element, options = {}) {
        ...
        this.dispatch = new EventHandlerDispatch_EventHandlerDispatch(
          element, this);
        ...
        this.navItems = [];
        this.subNavItems = [];
        this.parentItemSelector = ':scope > ul > .' + this.options
          .itemParentClass;
        this.navItemSelector = ':scope > ul > .' + this.options
          .itemClass + ':not(.' + this.options.itemParentClass + ')';
      }
      /**
      ...
      createSubNavItems() {
        ...
        var parentItems = this.elem.querySelectorAll(this
          .parentItemSelector);
      ...
      createParentItems(items, depth = 1, parentMenu = null) {
        items.forEach(
          item => {
            ...
            var parentItems = item.querySelectorAll(this
              .parentItemSelector);
            ...
            if (itemLink) {
              parentNav = this.newParentItem(itemLink, depth,
                parentMenu);
            }
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnHome.js
    /**
     * OnHome
     *
     * Event action handler class.
     */
    class OnHome_OnHome extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnArrowDown.js
    /**
     * OnArrowDown
     *
     * Event action handler class.
     */
    class OnArrowDown_OnArrowDown extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
        ...
        var eventHome = new OnHome_OnHome(this.item, this.event, this
          .target);
        eventHome.init();
      }
    }
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnEnd.js
    /**
     * OnEnd
     *
     * Event action handler class.
     */
    class OnEnd_OnEnd extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnArrowUp.js
    /**
     * OnArrowUp
     *
     * Event action handler class.
     */
    class OnArrowUp_OnArrowUp extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
        ...
        // Default to the end..
        var eventEnd = new OnEnd_OnEnd(this.item, this.event, this
        .target);
        eventEnd.init();
      }
    }
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnArrowLeft.js
    /**
     * OnArrowLeft
     *
     * Event action handler class.
     */
    class OnArrowLeft_OnArrowLeft extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
       ...
       */
      firstLevelLeft() {
        var upevent = new OnArrowUp_OnArrowUp(this.item, this.event, this
          .target);
        upevent.init();
      }
      /**
       ...
       */
      nestedLeft() {
        let node = this.getElement('parentItem') || this.getElement(
          'parentNavLast');
        this.parentNav.closeSubNav();
        if (node) {
          node.focus();
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnArrowRight.js
    /**
     * OnArrowRight
     *
     * Event action handler class.
     */
    class OnArrowRight_OnArrowRight extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
        ...
        if (this.item.getDepth() > 1) {
          ...
          var eventDown = new OnArrowDown_OnArrowDown(this.item, this
            .event, this.target);
          eventDown.init();
        }
      }
    }
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnEnter.js
    /**
     * OnEnter
     *
     * Event action handler class.
     */
    class OnEnter_OnEnter extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/events/OnTab.js
    /**
     * OnTab
     *
     * Event action handler class.
     */
    class OnTab_OnTab extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
        ...
        let lastItem = this.masterNav.elem.firstElementChild
          .lastElementChild.querySelector('li:last-child');
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/common/SecondaryNavItem.js
    // Keyboard control events.
    /**
     * SecondaryNav Class
     */
    class SecondaryNavItem_SecondaryNavItem {
      /**
       * Initialize.
       *
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/accordion/events/OnClick.js
    /**
     * OnClick
     *
     * Event action handler class.
     */
    class OnClick_OnClick extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/accordion/events/OnSpace.js
    /**
     * OnSpace
     *
     * Event action handler class.
     */
    class events_OnSpace_OnSpace extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
        ...
        var eventClick = new OnClick_OnClick(this.item, this.event, this
          .target);
        eventClick.init();
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/accordion/events/OnArrowRight.js
    /**
     * OnArrowRight
     *
     * Event action handler class.
     */
    class events_OnArrowRight_OnArrowRight extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/accordion/events/OnArrowLeft.js
    /**
     * OnArrowLeft
     *
     * Event action handler class.
     */
    class events_OnArrowLeft_OnArrowLeft extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
        ...
        // Overwise do what the navigate left option does.
          ...
          var otherLeft = new OnArrowLeft_OnArrowLeft(this.item, this
            .event, this.target);
          otherLeft.init();
        }
      }
    }
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/accordion/SecondarySubNavAccordion.js
    // Click handler.
    // Keyboard events.
    /**
     ...
     */
    class SecondarySubNavAccordion_SecondarySubNavAccordion {
      /**
       * Initialize.
       *
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/accordion/SecondaryNavAccordion.js
    /**
     * A secondary menu with accordion buttons.
     */
    class SecondaryNavAccordion_SecondaryNavAccordion extends SecondaryNavAbstract_SecondaryNavAbstract {
      /**
       * Initialize.
       *
      ...
      newParentItem(item, depth, parent) {
        ...
        opts.depth = depth;
        var nav = new SecondarySubNavAccordion_SecondarySubNavAccordion(
          item,
          this,
          parent,
          opts
      ...
      newNavItem(item, depth, parent) {
        var opts = this.options;
        opts.depth = depth;
        var nav = new SecondaryNavItem_SecondaryNavItem(
          item,
          this,
          parent,
          opts
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/secondary-nav-accordion.js
    document.addEventListener('DOMContentLoaded', event => {
      // Process each secondary nav accordion.
      secondaryNavs.forEach((nav, index) => {
        if (nav.className.match(/su-secondary-nav--accordion/)) {
          new SecondaryNavAccordion_SecondaryNavAccordion(nav);
        }
      });
    });
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/events/SubNavToggleClick.js
    /**
     * SubNavToggleClick
     *
     * Event action handler class.
     */
    class SubNavToggleClick_SubNavToggleClick extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/events/SubNavToggleSpace.js
    /**
     * SubNavToggleSpace
     *
     * Event action handler class.
     */
    class SubNavToggleSpace_SubNavToggleSpace extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
        ...
        var eventClick = new SubNavToggleClick_SubNavToggleClick(this
          .item, this.event, this.target);
        eventClick.init();
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/events/SubNavToggleArrowDown.js
    /**
     * SubNavToggleArrowDown
     *
     * Event action handler class.
     */
    class SubNavToggleArrowDown_SubNavToggleArrowDown extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/events/SubNavToggleArrowLeft.js
    /**
     * SubNavToggleArrowLeft
     *
     * Event action handler class.
     */
    class SubNavToggleArrowLeft_SubNavToggleArrowLeft extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/events/SubNavToggleArrowUp.js
    /**
     * SubNavToggleArrowUp
     *
     * Event action handler class.
     */
    class SubNavToggleArrowUp_SubNavToggleArrowUp extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/SubNavToggle.js
    // Events
    /**
     * A stoggle button.
     */
    class SubNavToggle_SubNavToggle {
      /**
       * Initialize.
       *
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/events/OnTab.js
    /**
     * OnTab
     *
     * Event action handler class.
     */
    class events_OnTab_OnTab extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
        ...
        const shifted = event.shiftKey;
        if (!shifted) {
          if (!this.getElement('nextElement') && this.item.getDepth() ===
            1) {
            this.masterNav.closeAllSubNavs();
          }
          return;
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/events/OnArrowRight.js
    /**
     * OnArrowRight
     *
     * Event action handler class.
     */
    class buttons_events_OnArrowRight_OnArrowRight extends EventAbstract_EventAbstract {
      /**
       * Execute the action to the event.
       */
      exec() {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/SecondarySubNavButtons.js
    // Events
    // Keyboard events.
    /**
     ...
     */
    class SecondarySubNavButtons_SecondarySubNavButtons {
      /**
       * Initialize.
       *
       * @param {HTMLElement} element     The container wrapper for the nav.
      ...
      constructor(element, masterNav, parentNav = null, options = {}) {
        ...
        this.item.insertBefore(this.toggleElement, this.item
          .querySelector('ul'));
        this.toggle = new SubNavToggle_SubNavToggle(this.toggleElement,
          this, options);
      }
      /**
       * Creates an event registry for handling types of events.
       ...
       */
      isExpanded() {
        return this.toggleElement.getAttribute('aria-expanded') ===
        'true';
      }
      /**
       * Handles the opening of a sub-nav.
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/buttons/SecondaryNavButtons.js
    /**
     * A secondary menu with toggle buttons.
     */
    class SecondaryNavButtons_SecondaryNavButtons extends SecondaryNavAbstract_SecondaryNavAbstract {
      /**
       * Initialize.
       *
       * @param {HTMLElement} elem  The outermost wrapper for the Navigation.
       ...
       */
      newParentItem(item, depth, parent) {
        var nav = new SecondarySubNavButtons_SecondarySubNavButtons(
          item,
          this,
          parent, {
    ...
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/secondary-nav-buttons.js
    document.addEventListener('DOMContentLoaded', event => {
      secondaryNavs.forEach((nav, index) => {
        if (nav.className.match(/su-secondary-nav--buttons/)) {
          new SecondaryNavButtons_SecondaryNavButtons(nav);
        }
      });
    });
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/secondary-nav/secondary-nav.js
    // Get'm
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/components/components.js
    /**
     * Primary roll up file for all javascript components.
     */
    // The Primary Navigation Component.
    // The Secondary Navigation Component.
    // EXTERNAL MODULE: ./node_modules/decanter/core/src/scss/decanter.scss
    var decanter = __webpack_require__(2);
    // CONCATENATED MODULE: ./node_modules/decanter/core/src/js/decanter.js
    // CONCATENATED MODULE: ./themes/decanter2020/source/_scripts/index.js
    /***/
  })
/******/
]);
