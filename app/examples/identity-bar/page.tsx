  ...
  return (
    <main id="main-content">
      ...
      <article className="cc rs-py-5">
        ...
        <div className="my-20 overflow-hidden border border-black-20"><IdentityBar /></div>
        <h2>Implementation</h2>
        <CodeBlock code={`<div className="bg-cardinal-red px-20 pt-5 pb-1 sm:px-30 md:px-50 lg:px-30">
