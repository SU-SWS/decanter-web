    ...
    <main id="main-content">
      ...
      <article className="cc rs-py-5">
        <section className="mb-56">
          ...
          <div className="my-20 bg-plum-dark text-white">
          ...
          <CodeBlock code={`<section className="bg-plum-dark text-white">
  <div className="cc rs-py-5">
    ...
    <p className="max-w-700 text-white/80">…</p>
        ...
        <section className="mb-56">
          ...
          <div className="my-20 border-l-5 border-cardinal-red bg-digital-red-xlight/10 px-20 py-16">
          ...
          <CodeBlock code={`<aside className="border-l-5 border-cardinal-red bg-digital-red-xlight/10 px-20 py-16">
  <h2 className="text-21">Application deadline updated</h2>
  <p>Applications now close Friday at 5:00 p.m. Pacific time.</p>
</aside>`} label="React" language="tsx" />
        </section>

        <section>
          <h2>Linked story card</h2>
          <div className="my-20 max-w-600 border border-black-20 bg-white p-24 shadow-sm">
            <article className="relative">
              <p className="mb-8 text-12 font-bold uppercase tracking-[0.12em] text-cardinal-red">Campus</p>
              <h3 className="mb-10 text-25"><a className="stretched-link text-black no-underline hocus:text-cardinal-red hocus:underline" href="#card-code">A simple card with one clear destination</a></h3>
          ...
          <div id="card-code">
            <CodeBlock code={`<article className="relative border border-black-20 p-24">
