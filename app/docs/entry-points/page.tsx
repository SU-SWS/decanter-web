...
@import 'decanter/src/css/utilities/modular-type.css';`}
          ...
          language="css"
        />
        <p>Importing <code>font-family.css</code> exposes Decanter’s font-family tokens, but it does not load any font files. Add Source Sans 3, Source Serif 4, and the Stanford wordmark font separately with the <Link href="/docs/installation#font-loading">font-loading snippets</Link> when those stacks are used.</p>
