      ...
      <article className="cc rs-py-5">
        <div className="grid gap-24 lg:grid-cols-3">
          <section className="border-t-5 border-plum bg-fog-light p-24">
            ...
            <Link className="font-bold text-plum-dark hover:text-plum hover:no-underline" href="/docs/typography">Typography documentation →</Link>
          </section>
          <section className="border-t-5 border-digital-blue bg-fog-light p-24">
            ...
            <Link className="font-bold text-digital-blue-dark hover:text-digital-blue hover:no-underline" href="/docs/layout">Layout documentation →</Link>
          </section>
          <section className="border-t-5 border-cardinal-red bg-fog-light p-24">
            ...
            <Link className="font-bold text-cardinal-red hover:text-plum hover:no-underline" href="/docs/colors">Color documentation →</Link>
          </section>
        </div>
